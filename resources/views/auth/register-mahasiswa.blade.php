<x-guest-layout>
    <div class="max-w-md mx-auto mt-6 p-5 rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('register.mahasiswa') }}">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium mb-1 text-white">Nama Lengkap</label>
            ...
            <button type="submit" class="w-full bg-gray-700 text-white font-medium py-2 rounded-md hover:bg-gray-500 transition">
                Daftar Sekarang
            </button>
